...
// 1) Book 클래스
// : 속성) title(String, 불변성), author(String,불변셩), isAvailable(Boolean)
// : 메서드) borrowBook(), returnBool(), displayInfo()
...
class Book{
	...
	void returnBook() {
		if(!isAvailable) {
			...
			System.out.println("이미 반납이된 상태입니다. (반납 x)");
		}
	...
	void displayInfo() {
		System.out.println("제목: " + title
				+ ", 저자: " + author
				+ ", 대여 가능 여부: " + (isAvailable ? "대여가능" : "대여 중")
		);
