...
public class A_if {
	...
	public static void main(String[] args) {
		...
		// 3. 각 분기에 위치할 경우 funcitonScope 변수에 몇 사분면인지 할당
		// EX) functionScope = "제 1사분면
		
		// 4. 조건문 이행 완료 시
		// "결과: " + functonScope 출력
		
		// 각 조건식에서 저장할 문자열값(사분면의 위치)을 담을 변수
