...
/*
 	...
 	- catch 블록: 특정 예외 타입이 발생했을 때 실행될 코드를 정의
 				>> 다중 catch 블록으로 사용 가능 (여러 예외 처리 기능)
 */
...
//		at chapter09.Exception02.main(Exception02.java:31)
		...
		try {
			System.out.println("정상 실행1");
			
//			int division = 10 / 0;
			
			System.out.println("51번째 줄 주석 시 실행");
			...
			// cf) Exception 클래스
			//		: 자바 전체 예외의 최상위 클래스
			//		- 예기치 못한 예외 발생 방지를위해 세부적인 예외 작성의 마지막에 첨부
		} finally {
