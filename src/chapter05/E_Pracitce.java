...
class BaseballPlayer{
	...
	//2) 정적 메서드
	// : 특정 홈런 수 이상인선수를 평가
	static String evaluationHomeRun(int homeRunCount) {
		if (homeRunCount > 20) {
...
public class E_Pracitce {
	...
	public static void main(String[] args) {
		...
		System.out.println(BaseballPlayer.evaluationHomeRun(player3.homeRuns));
		System.out.println(BaseballPlayer.evaluationHomeRun(player4.homeRuns));
	}
