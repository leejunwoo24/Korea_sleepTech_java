...
// == (메서드) 오버로딩 == //
// : overloading - 중복 정의
// : 한 클래스 내에서 동일한 이름의 '메서드'를 여러개 정의하는 것을 의미
...
//		: 코드의 재사용성, 가독성 향상
// - 컴파일 시 타입 체크 강화
//		: 올바른 매개변수를 가진 메서드를 자동선택

// 3. 오버로딩 단점
// : 중복적으로 의미없는 생성하는 경우, 실질적으로 필요한 구현 메서드 찾기에 어려움 (복잡성)
...
//		System.out.println(calc.add(10, 20, 30, 40)); 존재하지 않는 메서드
