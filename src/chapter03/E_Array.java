...
public class E_Array {
	public static void main(String[] args) {
		...
		// - Java Collecction Framework의 일부: 'java.util.ArrayList'에서 제공
		...
		// +) Collection Framework는 모든 클래스 내부에서 객체 구조만을 다룸
		// : 기본 타입 사용 X
		
		Integer a = null;
		//int b = null; cannot convert from null to int
