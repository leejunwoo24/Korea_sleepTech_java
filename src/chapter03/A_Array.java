...
public class A_Array { // 클래스명 == 파일명(대문자로 시작)
	...
	public static void main(String[] args) {
		...
		System.out.println(scores[1]);
		System.out.println(scores[2]);
//		System.out.println(scores[3]); ArrayIndexOutOfBoundsException (범위를 벗어남)
		
		// 배열의 선언과 동시에 초기화 //
		// : new 연산자 사용 + 직접적인 요소 대입의 배열 생성 시 길이 자정 X
		// >> 요소의 개수를 자동으로 파악하여 길이가 자동 지정
		...
		// System.out.println(greet[5]); ArrayIndexOutOfBoundsException (범위를 벗어남)
		...
		fruits[1] = "오랜지";
		System.out.println(fruits[1]); // 오랜지
