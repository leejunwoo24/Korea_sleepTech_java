...
class Book{
	...
	void displayInfo() {
		...
		return; // break와 유사한 동작을 수행
		//System.out.println("실행안된"); - 해당 코드에 접근할 수 없음
	}
...
public class D_Object {
	public static void main(String[] args) {
		...
		System.err.println(myBook.title); //null
		System.err.println(myBook.publisher); //null
		System.err.println(myBook.pageNumber); // 0
		...
		// 메서드 호출
		myBook.displayInfo(); // null
		anotherBook.displayInfo(); // 백설공주 코리아출판사
		thirdBook.displayInfo(); // 신데렐라 에이원플라자
