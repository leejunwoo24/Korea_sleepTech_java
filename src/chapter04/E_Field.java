...
public class E_Field {
	...
	public static void main(String[] args) {
		...
		System.out.println(CarClass.trieNumber); // 4
		CarClass.doorNumber = 4;
		System.out.println(CarClass.doorNumber); //4
		
		// cf) 각 객체명으로 호출 가능하지만 클래스명 호출 방법 권장!
		...
		// cf) 오류가 발생하지 않지만 사용은 하지 않음
		// car1.doorNumber = 10; // 객체명으로도 클래스 변수 접근 가능하긴 함
