...
public class BoardView {
	public static void main(String[] args) {
		...
		while(true) {
			...
			// Controller: 사용자가 입력과 선택을 받아 제어하는 역할 (백엔드)
			try {
				...
				case 4: 
					...
					BoardRequestDto dto = new BoardRequestDto(newTitle, newContent, "수정은 작성자 필드를 포함하지 않음");
					//BoardCreateRequestDto: 제목, 내용, 작성자
					// BoardUpdateRequestDto: 제목, 내영
				...
				case 0:
					...
					return;
				default: 
					System.out.println("잘 못된 선택입니다. 0~5 사이의 값을 입력해주세요");
				}
