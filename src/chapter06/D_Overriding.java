...
// == 오버라이딩(Overriding) == //
// : 자식 클래스가 부모 클래스에서 받은 상속받은 '메서드'를 자신의 상황에 맞게 '재정의'
...
// }
	...
	// : 자바에서 제공하는 코드 어노테이션(annotaion, 주석)
...
public class D_Overriding {
	...
	public static void main(String[] args) {
		...
		// : 메서드 동일
		// 		매개변수 타입, 개수, 순서 중 적어도 하나 이상은 달라야 함
		//		>> 반환타입은 상관 x
		// : 메서드 동작을 다양한 상황에 맞게 조정ㅁ
