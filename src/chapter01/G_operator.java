...
public class G_operator {
	public static void main(String[] args) {
		...
		System.out.println(10 * 20); // 곱셈 (*으로 표현)
		
		System.out.println(21 / 10); // 나눗셈 (/으로 표현)	- 나눈 결과의 몫을 저장	
		...
		System.out.println(--number); // 10 : -1 + 11 (감소) 후 출력
		...
		System.out.println(number -= 3); // number = nubmer - 3 (10)
		...
		// 정수를 담는 x, y 변수를 선언
		// 각각 10, 2를 할당
		// y값을 활용하여 x의 값이 짝수이면 "2의 배수입니다." 출력
		// x의 값이 홀수이면 " 2의 배수가 아닙니다." 출력
