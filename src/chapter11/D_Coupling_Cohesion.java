...
// - 낮은 응집도: 하나의 클래스 너무 많은 일을 하거나, 관련 없는 일을 하는 것
...
class KoreanTeach implements Teacher{
	@Override
	public void teach() {
...
class MathTeach implements Teacher{
	@Override
	public void teach() {
		System.out.println("수학 선생님은 수학를 가르칩니다.");
...
// 2) 높은 응집도
class StudentCohesion { // 학생은 기능만을 담당
	private String name;
...
public class D_Coupling_Cohesion {
	public static void main(String[] args) {
		Teacher koreanTeacher = new KoreanTeach();
		Teacher mathTeacher = new MathTeach();
