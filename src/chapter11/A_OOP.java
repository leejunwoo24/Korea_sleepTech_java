...
// - 적용 순서 x
// - 모두 필수 x
// - 서로 독립적 개념 x / 게념적으로 연관 O

// cf) 상속, 추상화, 다형성, 캡슈화 등은 OOP의 4가지 특징!
...
class LunchMenu{
	void serveLunch(String studentType) {
		...
		} else if(studentType.equals("주의학생")) {
			System.out.println("알레르기에 주의해주세요. >> 특별 배식구로 가주세요.");
		}
	}
}
...
class ReqularStudent implements LunchMenuInterface {
	@Override
...
class AllergyStudent implements LunchMenuInterface{
	...
	public void serveLunch() {
		// TODO Auto-generated method stub
	  System.out.println("주의 학생 - 특별 배식구로 제공합니다.");
	}
}
