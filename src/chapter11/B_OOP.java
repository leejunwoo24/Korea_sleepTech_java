...
class Employee implements Workable, Eatable{
	...
	@Override
	public void eat() {
		System.out.println("12시 부터 13시까지 점심시간 입니다.");
...
//1) 잘못된 예제 - WrongStudent가 MathBook에 의존, 다른 책을 학습하려면 코드 수정
class MathBook{
	void read() {
...
// 2) 올바른 예제 - 각 클래스 간의 결합도를 줄이고, 추상화에 의존!
interface Book{
	void read();
}
