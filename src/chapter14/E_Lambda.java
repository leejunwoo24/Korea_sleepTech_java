...
//		- compose(Functino before): 다른 Function의 결과를 현재 입력으로 연결
...
public class E_Lambda {
	public static void main(String[] args) {
		...
		Function<String, Integer> lengthAndSqure = StringLength.andThen(square);
		// : 문자열의 길이(숫자)값을 인자로 받아 계산
		System.out.println(lengthAndSqure.apply("이 문자열 길이의 제곱값은?"));
		...
		Consumer<String> cominedConsumber = printMessage.andThen(printLength);
		cominedConsumber.accept("123");
