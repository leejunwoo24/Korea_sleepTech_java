...
//		  : 사과 추가/제거 - 공간에 대한 정리 (속도 저하)
//		  : 사과 꺼내기 - 순차적인 수를 사용한 꺼내기 (속도 빠름)

// 2) LinkedList
// : 내부에서 이중 연결 리스트를 사용한 요소 저장
// - 빠른 삽입, 삭제 성능 / 느린 읽기 성능
// - 연결 기반 데이터 관리: 비순차적 데이터 작업에 적합, 특정 요 접근 시 순차 탐색이 필요하여 성능 저하
...
public class B_List {
	public static void main(String[] args) {
		...
		System.out.println(arrayList); // [Pyhon, TypeScript]
		...
		System.out.println(linkedList); // [Apple, Banna, Orange, Mango]
		...
		System.out.println(startTime); // 19991243296500 
